...
where $\sum_{[n_K]}$ sums over the dimension indexed by the number of keys. The gram matrix for is symmetric and positive semi-definite, giving us a kernel (Mercer's theorem).
